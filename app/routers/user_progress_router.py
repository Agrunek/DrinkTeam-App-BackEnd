...
def get_user_progress_for_recipe(user_id : int, recipe_id : int, db : _orm.Session = Depends(get_session),user_email: str = Depends(UserService.get_current_user)):
...
def initialize_user_progress_for_recipe(user_id : int, recipe_id : int, db : _orm.Session = Depends(get_session),user_email: str = Depends(UserService.get_current_user)):
...
def update_user_progress(user_id : int, recipe_id : int, go_next_step : bool, db : _orm.Session = Depends(get_session),user_email: str = Depends(UserService.get_current_user)):
